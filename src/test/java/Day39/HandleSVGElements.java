...
public class HandleSVGElements {
	...
	public static void main(String[] args) {
		...
		//abs xpath
		//driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[1]/aside/nav/div[2]/ul/li[4]/a/svg")).click();//NoSuchElementException: no such element: Unable to locate element:
				
		//rel xpath  using text
//		driver.findElement(By.xpath("//a[normalize-space()='']//*[name()='svg']")).click();//NoSuchElementException: no such element: Unable to locate element:
